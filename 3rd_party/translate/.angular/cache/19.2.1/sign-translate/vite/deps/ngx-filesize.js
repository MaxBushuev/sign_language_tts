...
// node_modules/ngx-filesize/fesm2020/ngx-filesize.mjs
var FileSizePipe = class _FileSizePipe {
  ...
  transform(value, options) {
    if (Array.isArray(value)) {
      return value.map((val) => _FileSizePipe.transformOne(val, options));
    }
    return _FileSizePipe.transformOne(value, options);
  }
};
FileSizePipe.ɵfac = function FileSizePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || FileSizePipe)();
};
FileSizePipe.ɵpipe = ɵɵdefinePipe({
  name: "filesize",
  type: FileSizePipe,
  pure: true,
  standalone: false
...
NgxFilesizeModule.ɵmod = ɵɵdefineNgModule({
  type: NgxFilesizeModule,
  declarations: [FileSizePipe],
  exports: [FileSizePipe]
});
NgxFilesizeModule.ɵinj = ɵɵdefineInjector({});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxFilesizeModule, [{
    type: NgModule,
    args: [{
      declarations: [FileSizePipe],
      exports: [FileSizePipe]
