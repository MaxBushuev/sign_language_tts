...
var require_flags_wasm = __commonJS({
  "node_modules/@tensorflow/tfjs-backend-wasm/dist/flags_wasm.js"(exports) {
    init_dist();
    var ENV = env();
    ENV.registerFlag("WASM_HAS_SIMD_SUPPORT", () => __async(exports, null, function* () {
      try {
    ...
    ENV.registerFlag("WASM_HAS_MULTITHREAD_SUPPORT", () => __async(exports, null, function* () {
      if (ENV.get("IS_NODE")) {
        return false;
      }
      try {
...
// node_modules/@tensorflow/tfjs-backend-wasm/dist/base.js
var WASM_PRIORITY = 2;
registerBackend("wasm", () => __async(void 0, null, function* () {
  const {
    wasm
  } = yield init();
